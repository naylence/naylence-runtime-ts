...
function buildStoreName(prefix: string, namespace: string, modelName: string): string {
...
export class IndexedDBStorageProvider extends EncryptedStorageProviderBase {
  static readonly supportedModes: ReadonlySet<IndexedDBStorageProviderMode> = new Set([
    "dx",
    "hardened",
  ]);
