...
const parseAddressComponentsMock =
  parseAddressComponents as jest.MockedFunction<typeof parseAddressComponents>;
...
describe('host logical validation', () => {
  ...
  it('validates collections of host logicals', () => {
    ...
    expect(validateHostLogicals(['example.com', '*.example.com'])).toEqual([
      true,
      null,
    ]);
