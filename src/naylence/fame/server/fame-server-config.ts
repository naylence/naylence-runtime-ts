...
export function normalizeFameServerConfig(
  input?: FameServerConfigInput | null
): FameServerConfig {
...
function normalizeRouteConfig(value: unknown): FameServerRouteConfig {
  const candidate = (value ?? {}) as Partial<FameServerRouteConfig> &
