...
import { KeyValidationError, type AttachmentKeyValidator } from '../../security/keys/attachment-key-validator.js';
...
export class DefaultNodeAttachClient implements NodeAttachClient {
  ...
  public async attach(
    ...
    const attachInfo: AttachInfo = {
      ...
      assignedPath,
      connector,
      ...(welcomeFrame.acceptedLogicals ? { acceptedLogicals: [...welcomeFrame.acceptedLogicals] } : {}),
