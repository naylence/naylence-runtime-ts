...
export type HttpConnectionGrantAuth = AuthInjectionStrategyConfig | Record<string, unknown> | undefined;
...
export function normalizeHttpConnectionGrant(candidate: HttpConnectionGrantLike): HttpConnectionGrant {
...
export function httpGrantToConnectorConfig(grant: HttpConnectionGrantLike): HttpStatelessConnectorConfigLike {
