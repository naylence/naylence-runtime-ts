...
describe('BroadcastChannelListener', () => {
  ...
  beforeEach(() => {
    ...
    originalBroadcastChannel = (globalThis as { BroadcastChannel?: unknown })
      .BroadcastChannel;
    originalMessageEvent = (globalThis as { MessageEvent?: unknown })
      .MessageEvent;

    (globalThis as { window?: unknown }).window = globalThis;
    (globalThis as { BroadcastChannel?: unknown }).BroadcastChannel =
      FakeBroadcastChannel;
    (globalThis as { MessageEvent?: unknown }).MessageEvent =
      FakeMessageEvent as unknown as typeof MessageEvent;
  });
