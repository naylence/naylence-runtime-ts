...
export const MODULE_LOADERS: Record<FactoryModuleSpec, FactoryModuleLoader> = {
  './connector/broadcast-channel-connector-factory.js': () =>
    import('./connector/broadcast-channel-connector-factory.js'),
  './connector/broadcast-channel-listener-factory.js': () =>
    import('./connector/broadcast-channel-listener-factory.js'),
  './connector/http-listener-factory.js': () =>
    import(
      /* webpackIgnore: true */ /* @vite-ignore */ './connector/http-listener-factory.js'
    ),
  './connector/http-stateless-connector-factory.js': () =>
    import('./connector/http-stateless-connector-factory.js'),
  './connector/inpage-connector-factory.js': () =>
    import('./connector/inpage-connector-factory.js'),
  './connector/inpage-listener-factory.js': () =>
    import('./connector/inpage-listener-factory.js'),
  './connector/websocket-connector-factory.js': () =>
    import('./connector/websocket-connector-factory.js'),
  './connector/websocket-listener-factory.js': () =>
    import(
      /* webpackIgnore: true */ /* @vite-ignore */ './connector/websocket-listener-factory.js'
    ),
  './delivery/at-least-once-delivery-policy-factory.js': () =>
  ...
  './security/auth/oauth2-pkce-token-provider-factory.js': () =>
    import('./security/auth/oauth2-pkce-token-provider-factory.js'),
  './security/auth/query-param-auth-injection-strategy-factory.js': () =>
  ...
  './security/credential/env-credential-provider-factory.js': () =>
    import('./security/credential/env-credential-provider-factory.js'),
  './security/credential/none-credential-provider-factory.js': () =>
    import('./security/credential/none-credential-provider-factory.js'),
  './security/credential/prompt-credential-provider-factory.js': () =>
    import(
      /* webpackIgnore: true */ /* @vite-ignore */ './security/credential/prompt-credential-provider-factory.js'
    ),
  './security/credential/secret-store-credential-provider-factory.js': () =>
    import('./security/credential/secret-store-credential-provider-factory.js'),
  './security/credential/session-key-credential-provider-factory.js': () =>
    import('./security/credential/session-key-credential-provider-factory.js'),
  './security/credential/static-credential-provider-factory.js': () =>
    import('./security/credential/static-credential-provider-factory.js'),
  './security/default-security-manager-factory.js': () =>
  ...
  './security/trust-store/noop-trust-store-provider-factory.js': () =>
    import('./security/trust-store/noop-trust-store-provider-factory.js'),
  './sentinel/capability-aware-routing-policy-factory.js': () =>
  ...
  './telemetry/open-telemetry-trace-emitter-factory.js': () =>
    import(
      /* webpackIgnore: true */ /* @vite-ignore */ './telemetry/open-telemetry-trace-emitter-factory.js'
    ),
  './telemetry/trace-emitter-profile-factory.js': () =>
