...
import { DefaultSecurityPolicy, type DefaultSecurityPolicyOptions } from './default-security-policy.js';
import {
...
function normalizeConfig(
	...
	const encryption = candidate.encryption as EncryptionConfiguration | EncryptionConfig | null | undefined;
