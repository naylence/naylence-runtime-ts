...
describe("Normalization helpers", () => {
  ...
  it("normalizes environment credential config variations", () => {
    ...
    expect(normalizeEnvConfig({ type: "EnvCredentialProvider", varName: "TOKEN_VAR" })).toEqual({
      type: "EnvCredentialProvider",
      varName: "TOKEN_VAR",
    });

    expect(normalizeEnvConfig({ type: "EnvCredentialProvider", var_name: "legacy_var" })).toEqual({
      type: "EnvCredentialProvider",
      varName: "legacy_var",
    });
