...
export interface CreateCertificateManagerOptions extends Omit<CreateResourceOptions, 'factoryArgs'> {
...
> extends AbstractResourceFactory<CertificateManager, C> {
	...
	public static async createCertificateManager<C extends CertificateManagerConfig = CertificateManagerConfig>(
