...
export class RoutingProfileFactory extends RoutingPolicyFactory {
  ...
  public async create(
    ...
    const policy = await createResource<RoutingPolicy>(ROUTING_POLICY_FACTORY_BASE, routingConfig, {
      factoryArgs: kwargs,
      validate: false,
    });
