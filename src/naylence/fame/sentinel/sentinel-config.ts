...
export function normalizeSentinelConfig(
  ...
  return {
    ...base,
    type: 'Sentinel',
    routingPolicy: (source.routingPolicy ?? null) as RoutingPolicyConfig | Record<string, unknown> | null,
    loadBalancing: (source.loadBalancing ?? null) as LoadBalancingStrategyConfig | Record<string, unknown> | null,
    stickiness: (source.stickiness ?? null) as LoadBalancerStickinessManagerConfig | Record<string, unknown> | null,
    peers,
