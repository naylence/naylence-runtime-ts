...
export abstract class RoutingPolicyFactory implements BaseResourceFactory<RoutingPolicy, RoutingPolicyConfig> {
  ...
  public static async createRoutingPolicy(
    ...
    const policy = await createDefaultResource<RoutingPolicy>(ROUTING_POLICY_FACTORY_BASE, config ?? null, {
